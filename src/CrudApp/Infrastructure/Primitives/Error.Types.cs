...
public partial class Error
{
    ...
    // 400 Bad request
    //
    public sealed class ModelValidationFailed(Dictionary<string, string[]> errors) : Error(HttpStatus.BadRequest, errors: errors);
    public sealed class CannotCreateDeletedEntity(Type entityType, EntityId entityId, Exception? exception = null) : Error(HttpStatus.BadRequest, exception, new DataDictionary().Add(entityType).Add(entityId));
